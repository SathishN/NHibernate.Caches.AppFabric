...
{
    /// <summary>
    /// An implementation of the the <see cref="AppFabricCacheAdapter"/> that uses an AppFabric region
    ...
    public class AppFabricCacheRegionAdapter : AppFabricCacheAdapter
    {
        ...
        /// <summary>
        /// The name of the region to store data in - corresponds to the NHibernate region.
        /// </summary>
